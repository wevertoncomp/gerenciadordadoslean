...
echo "	</div>";
echo "	<div class='panel-body'>";
echo "		Quantidade(sem BOR, TRM...): " .number_format($qtdNaoConformesGrandesInj, 2, ',', '.');
echo "		<br/>Peso(sem BOR, TRM...): " .number_format($pesoNaoConformesGrandesInj, 2, ',', '.');
echo "		<br/>";
...
echo "	</div>";
echo "	<div class='panel-body'>";
echo "		Quantidade(sem BOR, TRM...): " .number_format($qtdProducaoINJTRComFiltros, 2, ',', '.');
echo "		<br/>Peso(sem BOR, TRM...): " .number_format($pesoProducaoINJTRComFiltros, 2, ',', '.');
echo "		<br/>";
